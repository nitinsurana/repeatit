window.recipe = {}, window.recipelist = ["PassageCreateRecipe"], window.recipe.Recipe = function (e) {
    this.start = function () {
    }, this.stop = function () {
    }, this.steps = e, this.wait = 20
}, window.recipe.RecipePlayer = function (e) {
    ...
    "function" == typeof e.start && e.start.call(e), s(e.steps, t), "function" == typeof e.stop && e.stop.call(e)
}, function () {
    var e = [{
        selector: "#question-raw-content", action: function () {
            $(this).redactor("set", "Filling T/F question")
        }
    }], t = window.recipe.FillTrueFalseRecipe = new window.recipe.Recipe(e);
    t.start = function () {
    ...
    var e = [{selector: "#create-assessment-with-val"}, {selector: "span.lsm-create-btn:first"}, {
        ...
        selector: "#saveQuestionDetails1",
        action: "click"
    }, {selector: ".as-question-editor-back"}], t = window.recipe.PassageCreateRecipe = new window.recipe.Recipe(e);
    t.start = function () {
        Backbone.history.loadUrl("#createAssessment/close?cm=assessment")
    }
}();